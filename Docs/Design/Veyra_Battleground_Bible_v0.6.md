...
| **VERSION**       | 0.6 - Flux Spells / 17-Vanguard Ranked Prototype |
|-------------------|--------------------------------|
...
- Flux Spells are purchased from a dedicated shop section while the player is at the shop.
- Equipping a Flux Spell does not make it immediately usable if its required Flux threshold has not yet been reached.

### Shared Flux thresholds

Each Flux Spell has a required **shared Team Flux threshold**.

- An equipped Flux Spell remains inactive until the player's team reaches that threshold.
...
- Exact thresholds and threshold structure remain tunable/data-driven unless explicitly locked later.

### Swapping and adaptation

Players may change their equipped Flux Spells only while at the shop.
