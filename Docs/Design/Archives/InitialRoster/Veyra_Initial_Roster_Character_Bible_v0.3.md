> Repository Markdown edition derived from Veyra Initial Roster Character Bible v0.3. Embedded concept art from the original Word document is omitted.

# Veyra Initial Roster Character Bible

**Version:** 0.3  
**Roster target:** 15 Vanguards  
**Status:** Working canon for the first playable roster.
...
Qazharr arrived in the Cantons intending a short stay, fell in love with the ports, people, food, drinking culture, and everyday life, and simply stayed.
...
Marek, Neris, and Qazharr all connect to the Cantons from very different cultural angles.
...
The first 15 should collectively demonstrate that Veyra supports:
